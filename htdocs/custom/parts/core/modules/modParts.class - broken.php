 ...
 * Copyright (C) 2018 Peter Roberts
 *
...
class modParts extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		// Module label (no space allowed), used if translation string 'ModulePartsName' not found (MyModue is name of module).
		$this->name = preg_replace('/^mod/i','',get_class($this));
		// Module description, used if translation string 'ModulePartsDesc' not found (MyModule is name of module).
		...
		$this->version = '1.0';
		// Key used in llx_const table to save module status enabled/disabled (where PARTS is value of property name of module in uppercase)
		...
		// for default path (eg: /parts/core/xxxxx) (0=disable, 1=enable)
		// for specific path of parts (eg: /parts/core/modules/barcode)
		// for specific css file (eg: /parts/css/parts.css.php)
        ...
        $this->tabs = array(
			'data'=>'project:+parts:Parts:timesheet@timesheet::/custom/parts.php?id=__ID__'
		);
		// Example:
        ...
        */
        ...
        // Boxes/Widgets
		// Add here list of php file(s) stored in parts/core/boxes that contains class to show a widget.
        $this->boxes = array(
        	0 => array(
		...
		$this->menu[$r++]=array(
			...
			'position'=>1000+$r,
			'enabled'=>'$conf->parts->enabled',		// Define condition to show or hide menu entry. Use '$conf->parts->enabled' if entry must be visible if module is enabled.
		...
		$this->menu[$r++]=array(
			...
			'type'=>'left',							// This is a Left menu entry
			'titre'=>'New PartsRequest',
			'mainmenu'=>'parts',
			'leftmenu'=>'parts_partsrequest_new',
			'url'=>'/parts/partsrequest_page.php?action=create',
			'langs'=>'parts@parts',	        		// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>1000+$r,
			'enabled'=>'$conf->parts->enabled',		// Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
			'perms'=>'1',			                // Use 'perms'=>'$user->rights->mymodule->level1->level2' if you want your menu with a permission rules
		...
		$this->menu[$r++]=array(
			'fk_menu'=>'fk_mainmenu=parts',	    	// '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
			'type'=>'left',							// This is a Left menu entry
			'titre'=>'List PartsRequest',
			'mainmenu'=>'parts',
			'leftmenu'=>'parts_partsrequest',
			'url'=>'/parts/partsrequest_list.php',
			'langs'=>'parts@parts',	        		// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>1100+$r,
			'enabled'=>'$conf->parts->enabled',  // Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
			'perms'=>'1',			                // Use 'perms'=>'$user->rights->mymodule->level1->level2' if you want your menu with a permission rules
		...
		$this->menu[$r++]=array(
			'fk_menu'=>'fk_mainmenu=parts,fk_leftmenu=parts_partsrequest',	// '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
			'type'=>'left',							// This is a Left menu entry
			'titre'=>'New PartsRequest',
			'mainmenu'=>'parts',
			'leftmenu'=>'parts_partsrequest',
			'url'=>'/parts/partsrequest_card.php?action=create',
			'langs'=>'parts@parts',	        		// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>1100+$r,
		...
		$keyforclass = 'PartsRequest'; $keyforclassfile='/mymobule/class/partsrequest.class.php'; $keyforelement='partsrequest';
		include DOL_DOCUMENT_ROOT.'/core/commonfieldsinexport.inc.php';
		$keyforselect='partsrequest'; $keyforaliasextra='extra'; $keyforelement='partsrequest';
