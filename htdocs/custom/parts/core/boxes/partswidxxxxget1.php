...
/**
 * \file    modulebuilder/template/core/boxes/partswidget1.php
 * \ingroup parts
 * \brief   Widget provided by Parts
 *
 ...
 */
class partswidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "partsbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "parts@parts";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->parts->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/parts/class/parts.class.php";

		// Populate the head at runtime
		$text = $langs->trans("PartsBoxDescription", $max);
