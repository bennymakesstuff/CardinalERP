...
$sql.= ', cfd.ref AS cfd_ref';
$sql.= ', cd.label AS cfd_label';
...
$sql.= ', cfd.total_ht AS cfdtotal_ht';
$sql.= ', cfd.total_tva AS cfdtotal_tva';
$sql.= ', cfd.total_ttc AS cfdtotal_ttc';			
...
//	date_approve2
//	date_commande
//$sql.= ', cf.fk_user_author AS cffk_user_author';			//	fk_user_author
//	fk_user_modif
//	fk_user_valid
//	fk_user_approve
//	fk_user_approve2
...
*/
	...
	if (! empty($arrayfields['c.date_commande']['checked']))
	{
		...
		print dol_print_date($orderstatic->date_commande, 'day');
		print '</td>';
	}
	...
	{
		print '<td align="center">';
		print dol_print_date($orderstatic->date_delivery, 'day');
		print '</td>';
	}
...
*/
	...
	{
		print '<td>';
		if ($purchaseorderfound && $purchaseorderstatic->user_author_id)
		{
			$userstatic = new User($db);
			$userstatic->fetch($purchaseorderstatic->user_author_id);
