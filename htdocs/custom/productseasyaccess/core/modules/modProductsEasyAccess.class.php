...
/**
 *	\file       htdocs/productseasyaccess/core/modules/modProductsEasyAccess.class.php
 * 	\defgroup   productseasyaccess     Module ProductsEasyAccess
 *     \brief      Dolibarr's module definition file for ProductsEasyAccess (meta-informations file)
 */
include_once(DOL_DOCUMENT_ROOT ."/core/modules/DolibarrModules.class.php");


/**
 * 		\class      modProductsEasyAccess
 *     	\brief      Dolibarr's module definition file for ProductsEasyAccess (meta-informations file)
 */
class modProductsEasyAccess extends DolibarrModules
{
	/**
	...
	function __construct($db)
	{
            ...
            $this->rights_class = 'productseasyaccess';
            ...
            $this->description = "Tool to easily access products' fields (standard and custom fields) from PDF and ODT templates";
            ...
            $this->module_parts = array('triggers' => 0, 'substitutions' => 0,
                                        'hooks'=>array('odtgeneration') ); // double array_flip() + array_merge() = array_unique but is way faster
            //$this->module_parts = array('triggers' => 1,
            //              'login' => 0,
            //              'substitutions' => 0,
            //              'menus' => 0);
            // Defined if the directory /mymodule/includes/triggers/ contains triggers or not
            $this->triggers = 0; // TOFIX: can be removed now?
            ...
            $this->langfiles = array("productseasyaccess@productseasyaccess", "customfields@customfields", "customfields-user@customfields"); // compatibility with custom fields translation
