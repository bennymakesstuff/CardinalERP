...
/**
 *	\file       htdocs/wip/template/wipindex.php
 *	\ingroup    wip
 *	\brief      Home page of wip top menu
 */
...
$langs->loadLangs(array("wip@wip"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->wip->read) accessforbidden();
...
llxHeader("",$langs->trans("WIPArea"));

print load_fiche_titre($langs->trans("WIPArea"),'','wip.png@wip');
...
// Draft MyObject
if (! empty($conf->wip->enabled) && $user->rights->wip->read)
{
	$langs->load("orders");
