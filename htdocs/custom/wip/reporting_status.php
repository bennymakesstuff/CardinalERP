...
/**
 *	\file		htdocs/custom/wip/reporting_status.php
 *	\ingroup	wip
 *	\brief		Page to list reporting status of projects
 */
...
//	'commercial'=>array('label'=>$langs->trans("SaleRepresentativesOfThirdParty"), 'checked'=>0),
	'p.dateo'=>array('label'=>$langs->trans("DateStart"), 'checked'=>0, 'position'=>100),
	'p.datee'=>array('label'=>$langs->trans("DateEnd"), 'checked'=>0, 'position'=>101),
//	Time spent
	'r.hrs_spent'=>array('label'=>$langs->trans("WIP_Hours_Spent"), 'checked'=>1, 'position'=>102),
//	Hours Unreported
	'r.hrs_unrep'=>array('label'=>$langs->trans("WIP_Hours_Unrep"), 'checked'=>1, 'position'=>103),
//	Hours in process
	'r.hrs_inpro'=>array('label'=>$langs->trans("WIP_Hours_InPro"), 'checked'=>1, 'position'=>104),
//	Orphan Hours
	'r.hrs_orphn'=>array('label'=>$langs->trans("WIP_Hours_Orphn"), 'checked'=>1, 'position'=>105),
//	Hours Reported
	'r.hrs_reprt'=>array('label'=>$langs->trans("WIP_Hours_Reprt"), 'checked'=>1, 'position'=>106),
//	Hours Invoiced
	'r.hrs_billd'=>array('label'=>$langs->trans("WIP_Hours_Billd"), 'checked'=>1, 'position'=>107),
//	Hours Discounted
	'r.hrs_discd'=>array('label'=>$langs->trans("WIP_Hours_Discd"), 'checked'=>0, 'position'=>108),
//	Rework Hours
	'r.hrs_rewrk'=>array('label'=>$langs->trans("WIP_Hours_Rewrk"), 'checked'=>0, 'position'=>109),
//	Last Report
	'r.hrs_larpt'=>array('label'=>$langs->trans("WIP_Last_Report"), 'checked'=>0, 'position'=>110),
//	Last Invoice
	'r.hrs_lainv'=>array('label'=>$langs->trans("WIP_Last_Invoice"), 'checked'=>0, 'position'=>111),
...
if ($search_project_user == $user->id) $contentdesc = $langs->trans("WIP_MyProjectsDesc");
else
{
	if ($user->rights->projet->all->lire && ! $socid) $contentdesc = $langs->trans("WIP_ProjectsDesc");
	else $contentdesc = $langs->trans("WIP_ProjectsPublicDesc");
}
