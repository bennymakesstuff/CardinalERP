...
//	public $picto = 'projectpub';
	...
	public $fields=array(
		...
		'duration' => array('type'=>'double', 'label'=>'DurationSeconds', 'enabled'=>1, 'visible'=>1, 'position'=>69, 'notnull'=>-1,),
		...
		'billable' => array('type'=>'integer', 'label'=>'Billable', 'enabled'=>1, 'visible'=>1, 'position'=>1020, 'notnull'=>1, 'default'=>'0', 'index'=>1, 'arrayofkeyval'=>array('0'=>'Non-billable', '1'=>'Billable', '2'=>'Discounted')),
...
//		if ($mode == 1) $sql = "SELECT";
	 ...
	 */
	public function getPacketTimeSumArray($packetid=0, $billperiod=1)
	{
		global $conf;
	...
	function updateReportSums($packetsarray)
	{
		...
		for ($i = 0 ; $i < $numlines ; $i++) {
			$packetsumarray = array();
			$packetsumarray = $packettemp->getPacketTimeSumArray($packetsarray[$i], $billperiod);
