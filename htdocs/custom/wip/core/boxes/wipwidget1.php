...
/**
 * \file    modulebuilder/template/core/boxes/wipwidget1.php
 * \ingroup wip
 * \brief   Widget provided by WIP
 *
 ...
 */
class wipwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "wipbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "wip@wip";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->wip->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/wip/class/wip.class.php";

		// Populate the head at runtime
		$text = $langs->trans("WIPBoxDescription", $max);
