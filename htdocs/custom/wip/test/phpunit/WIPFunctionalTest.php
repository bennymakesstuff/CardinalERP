...
/**
 * \file    test/functional/PartsFunctionalTest.php
 * \ingroup parts
 ...
 * @package Testparts
 */
class PartsFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	{
		$this->url('/custom/parts/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('parts/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/parts/admin/about.php');
		$this->authenticate();
		return $this->assertContains('parts/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('partswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modParts_PartsTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modParts_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
