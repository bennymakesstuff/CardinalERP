[onshow;block=begin;when [view.mode]!='new']
	...
	<table class="nobrder" style="width:100%;">
		...
		[onshow;block=end]
		<tr>
			<td> from [view.date_deb;strconv=no] to [view.date_fin;strconv=no] Filter user : [view.liste_user;strconv=no] <input class="button" type="submit" name="save" class="butAction" value="Visualiser"></td>
		</tr>
	</table>
	<br><br>
