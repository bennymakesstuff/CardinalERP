...
require_once './class/timecardreport.class.php';
...
dol_syslog("timecard::report::projectList sql=".$sql, LOG_DEBUG);
...
if ($resql)
{
        ...
        while ($i < $numProject)
        {
                ...
                $projectList[$obj->rowid]=new timecardReport($db);
        ...
        &&!empty($_POST['month']))
{
    ...
    if($_POST['projectSelected']=='-999'){
        ...
        $querryRes.=$project->getHTMLreport($firstDay,$lastDay,$mode,$short,
            ...
            (TIMECARD_TIME_TYPE=='days')?TIMECARD_DAY_DURATION:0,$exportfriendly);
        }
    }else{
