...
/**
 *	\file       htdocs/custom/timecard/timecard.php
 *	\ingroup    timecard
 *	\brief      Page to add new timecard data
 */
...
include_once DOL_DOCUMENT_ROOT.'/core/lib/includeMain.lib.php';
...
// PJRXXX if (!$user->rights->projet->lire) accessforbidden();
