...
function checkMultiCompanyVersion()
{
	...
	if (empty($conf->global->MULTICOMPANY_MAIN_VERSION) || (version_compare($dolversion[0], '11', '=') && version_compare($conf->global->MULTICOMPANY_MAIN_VERSION, '11.0.0', '<'))) {
		$out = -2;
	} else {
		$out = version_compare($dolversion[0], '11');
	}
