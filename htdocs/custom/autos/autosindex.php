...
/**
 *	\file       htdocs/autos/template/autosindex.php
 *	\ingroup    autos
 *	\brief      Home page of autos top menu
 */
...
$langs->loadLangs(array("autos@autos"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->autos->read) accessforbidden();
...
llxHeader("",$langs->trans("AutosArea"));

print load_fiche_titre($langs->trans("AutosArea"),'','autos.png@autos');
...
// Draft MyObject
if (! empty($conf->autos->enabled) && $user->rights->autos->read)
{
	$langs->load("orders");
