...
/**
 * \file    modulebuilder/template/core/boxes/autoswidget1.php
 * \ingroup autos
 * \brief   Widget provided by Autos
 *
 ...
 */
class autoswidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "autosbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "autos@autos";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->autos->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/autos/class/autos.class.php";

		// Populate the head at runtime
		$text = $langs->trans("AutosBoxDescription", $max);
