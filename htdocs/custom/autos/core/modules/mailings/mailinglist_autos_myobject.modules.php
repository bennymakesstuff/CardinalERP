...
dol_include_once("/autos/class/myobject.class.php");


/**
 * mailing_mailinglist_autos
 */
class mailing_mailinglist_autos_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_autos_myobject';
	...
	function __construct($db)
	{
		...
		{
			$this->enabled=in_array('autos',$conf->modules)?1:0;
		}
	}
	...
	function url($id)
	{
		return '<a href="'.dol_buildpath('/autos/myobject_card.php',1).'?id='.$id.'">'.img_object('',"generic").'</a>';
	}
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		if ($result)
		{
			...
			dol_syslog("mailinglist_autos_myobject.modules.php: mailing ".$num." targets found");
