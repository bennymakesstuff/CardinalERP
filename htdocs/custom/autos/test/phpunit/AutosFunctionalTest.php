...
/**
 * \file    test/functional/AutosFunctionalTest.php
 * \ingroup autos
 ...
 * @package Testautos
 */
class AutosFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	{
		$this->url('/custom/autos/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('autos/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/autos/admin/about.php');
		$this->authenticate();
		return $this->assertContains('autos/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('autoswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modAutos_AutosTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modAutos_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
