...
<tr <?php echo $bc[$var]; ?>>
	...
	<td><input type="text" name="marge_gauche" id="marge_gauche" size="30" value="<?php echo $this->tpl['marge_gauche']?10:$this->tpl['marge_gauche']; ?>" /><br><input type="text" name="marge_droite" id="marge_droite" size="30" value="<?php echo $this->tpl['marge_droite']?10:$this->tpl['marge_droite']; ?>" /><br><input type="text" name="marge_haute" id="marge_haute" size="30" value="<?php echo $this->tpl['marge_haute']?10:$this->tpl['marge_haute']; ?>" /><br><input type="text" name="marge_basse" id="marge_basse" size="30" value="<?php echo $this->tpl['marge_basse']?10:$this->tpl['marge_basse']; ?>" /><br><span id="resizable-6"></span></td>	
</tr>
</table>
<br>
...
<tr <?php echo $bc[$var]; ?>>
	...
	<td><input type="text" name="widthnumbering" id="widthnumbering" size="30" value="<?php echo $this->tpl['widthnumbering']?10:$this->tpl['widthnumbering']; ?>" /><br><span id="resizable-14"></span></td>
	<td><button type="button" id="maj_img"><?php echo $langs->trans("Update"); ?></button></td>	
</tr>
</table>
<br>
...
<tr <?php echo $bc[$var]; ?>>
	...
	<td><input type="text" name="widthvat" id="widthvat" size="30" value="<?php echo $this->tpl['widthvat']; ?>" /><br><span id="resizable-16"></span></td>
	<td><button type="button" id="maj_img"><?php echo $langs->trans("Update"); ?></button></td>	
</tr>
</table>
<br>
...
<tr <?php echo $bc[$var]; ?>>
	...
	<td colspan="2"><input name="freetextfontsize" size="25" value="<?php echo $this->tpl['select_freetextfontsize']; ?>" /></td>
...
<tr <?php echo $bc[$var]; ?>>
	...
	<td><input type="text" name="heightforfreetext" id="heightforfreetext" size="25" value="<?php echo $this->tpl['select_heightforfreetext']; ?>" /><br><span id="resizable-12"></span></td>
	<td><button type="button" id="maj_img"><?php echo $langs->trans("Update"); ?></button></td>
</tr>
</table>
<br>
...
<tr <?php echo $bc[$var]; ?>>
	...
	<td colspan="2"><?php echo $this->tpl['select_footertextcolor']; ?></td>
	<td ><?php echo '&nbsp'; ?></td>
</tr>
</table>
<br>
