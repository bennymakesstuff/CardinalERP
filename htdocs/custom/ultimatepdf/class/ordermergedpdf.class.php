...
class Ordermergedpdf extends CommonObject
{
	...
	var $element='ultimatepdf_order_merged_pdf';			//!< Id that identify managed objects
	var $table_element='ultimatepdf_order_merged_pdf';		//!< Name of table without prefix where object is stored
    ...
    function create($user, $notrigger=0)
    {
        ...
        // Insert request
		$sql = "INSERT INTO ".MAIN_DB_PREFIX."ultimatepdf_order_merged_pdf(";
		...
		if (! $error)
        {
            $this->id = $this->db->last_insert_id(MAIN_DB_PREFIX."ultimatepdf_order_merged_pdf");
    ...
    function fetch($id)
    {
        ...
        $sql.= " FROM ".MAIN_DB_PREFIX."ultimatepdf_order_merged_pdf as t";
    ...
    function update($user=0, $notrigger=0)
    {
        ...
        // Update request
        $sql = "UPDATE ".MAIN_DB_PREFIX."ultimatepdf_order_merged_pdf SET";
	...
	function delete($user, $notrigger=0)
	{
		...
		if (! $error)
		{
    		$sql = "DELETE FROM ".MAIN_DB_PREFIX."ultimatepdf_order_merged_pdf";
    		$sql.= " WHERE rowid=".$this->id;
