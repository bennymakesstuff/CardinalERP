...
/**
 *	\file       core/modules/commande/doc/pdf_ultimate_weight_order1.modules.php
 *	\ingroup    commande
 *	\brief      Fichier de la classe permettant de generer les commandes au modele ultimate_weight_order1 
 */
...
/**
 *	Class for generate the commands with ultimate_weight_order1 model
 */
class pdf_ultimate_weight_order1 extends pdf_ultimate_order1
{
	...
	public function __construct($db)
	{
		...
		$this->name = "ultimate_weight_order1";
		$this->description = $langs->trans('PDFUltimate_weightOrder1Description');
	...
	function write_file($object,$outputlangs,$srctemplatepath='',$hidedetails=0,$hidedesc=0,$hideref=0)
	{
		...
		if ($conf->commande->dir_output)
		{
			...
			{	
				...
				{
					$heightforinfotot = 62;	// Height reserved to output the info and total part
				}
				else
				{
					$heightforinfotot = 40;
	...
	function _tableau_tot(&$pdf, $object, $deja_regle, $posy, $outputlangs)
	{
	   global $conf,$mysoc,$langs;
		...
		$pdf->RoundedRect($deltax, $tab2_top, $widthrecbox, 26, 2, $round_corner = '1111', 'FD', $this->style, $bgcolor);
		$pdf->SetAlpha(1);
	...
	function _tableau(&$pdf, $tab_top, $tab_height, $nexY, $outputlangs, $hidetop=0, $hidebottom=0)
	{
		...
		$pdf->RoundedRect($this->marge_gauche, $tab_top, $this->page_largeur-$this->marge_gauche-$this->marge_droite, $tab_height, 2, $round_corner = '0110','S', $this->style, array(200, 210, 234),$hidetop, $hidebottom );
		...
		if (empty($hidetop))
		{
			...
			$pdf->MultiCell($this->posxdiscount-$this->posxweight,6, $outputlangs->transnoentities("Weight"),0,'C',1);
		}	
