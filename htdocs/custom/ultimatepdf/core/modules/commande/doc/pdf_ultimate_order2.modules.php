...
/**
 *	\file       core/modules/commande/doc/pdf_ultimate_order2.modules.php
 *	\ingroup    commande
 *	\brief      Fichier de la classe permettant de generer les commandes au modele ultimate_order2 
 */
...
/**
 *	Class for generate the commands with ultimate_order2 model
 */
class pdf_ultimate_order2 extends pdf_ultimate_order1
{
	...
	public function __construct($db)
	{
		...
		$this->name = "ultimate_order2";
		$this->description = $langs->trans('PDFUltimate_order2Description');
