 ...
 */
class workstationbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "workstation@workstation";
    public $boxlabel;
    public $depends = array("workstation");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/workstation/class/workstation.class.php";
