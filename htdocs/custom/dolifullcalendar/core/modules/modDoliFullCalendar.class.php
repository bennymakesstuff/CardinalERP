<?php
/* advanced interactive calendar based plugin jquery FullCalendar
...
/**
 * 	\defgroup	dolifullcalendar	DoliFullCalendar module
 * 	\brief		advanced interactive calendar.
 * 	\file		core/modules/modDoliFullCalendar.class.php
 * 	\ingroup	dolifullcalendar
 * 	\brief		Description and activation file for module DoliFullCalendar
 */
include_once DOL_DOCUMENT_ROOT . "/core/modules/DolibarrModules.class.php";

/**
 * Description and activation class for module DoliFullCalendar
 */
class modDoliFullCalendar extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->rights_class = 'dolifullcalendar';
		...
		// (where XXX is value of numeric property 'numero' of module)
		$this->description = "advanced interactive calendar";
		...
		$this->picto = 'dolifullcalendar@dolifullcalendar'; // mypicto@dolifullcalendar
		// Defined all module parts (triggers, login, substitutions, menus, css, etc...)
		// for default path (eg: /dolifullcalendar/core/xxxxx) (0=disable, 1=enable)
		// for specific path of parts (eg: /dolifullcalendar/core/modules/barcode)
		// for specific css file (eg: /dolifullcalendar/css/dolifullcalendar.css.php)
		$this->module_parts = array(
			...
			'css' => array('dolifullcalendar/css/fullcalendar.css', 'dolifullcalendar/css/modal.bootstrap.min.css'),
			// Set this to relative path of js file if module must load a js on all pages
			'js' => array('dolifullcalendar/js/moment.min.js', 'dolifullcalendar/js/fullcalendar.min.js', 'dolifullcalendar/js/fr.js', 'dolifullcalendar/js/en.js', 'dolifullcalendar/js/modal.bootstrap.min.js'),
			...
			//         'picto' => 'yourpicto@dolifullcalendar',
		...
		// Example: this->dirs = array("/dolifullcalendar/temp");
		$this->dirs = array();

		// Config pages. Put here list of php pages
		// stored into dolifullcalendar/admin directory, used to setup module.
		$this->config_page_url = array("admin_mymodule.php@dolifullcalendar");
		...
		// Language files list (langfiles@dolifullcalendar)
		$this->langfiles = array("dolifullcalendar@dolifullcalendar");
		// Constants
		...
		$this->tabs = array(
			...
			//	'objecttype:+tabname1:Title1:langfile@dolifullcalendar:$user->rights->dolifullcalendar->read:/dolifullcalendar/mynewtab1.php?id=__ID__',
			//	// To add another new tab identified by code tabname2
			//	'objecttype:+tabname2:Title2:langfile@dolifullcalendar:$user->rights->othermodule->read:/dolifullcalendar/mynewtab2.php?id=__ID__',
		...
		// Dictionaries
		if (! isset($conf->dolifullcalendar->enabled)) {
			$conf->dolifullcalendar=new stdClass();
			$conf->dolifullcalendar->enabled = 0;
		}
		$this->dictionaries = array();
		/* Example:
		  // This is to avoid warnings
		  if (! isset($conf->dolifullcalendar->enabled)) $conf->dolifullcalendar->enabled=0;
		  $this->dictionaries=array(
			  'langs'=>'dolifullcalendar@dolifullcalendar',
		...
		// This menu's mainmenu ID
			'mainmenu'=>'dolifullcalendar',
		// This menu's leftmenu ID
			'leftmenu'=>'dolifullcalendar',
			'url'=>'/dolifullcalendar/index.php',
		//	// Lang file to use (without .lang) by module.
		//	// File must be in langs/code_CODE/ directory.
		//	'langs'=>'mylangfile',
			'position'=>100,
		//	// Define condition to show or hide menu entry.
		//	// Use '$conf->dolifullcalendar->enabled' if entry must be visible if module is enabled.
			'enabled'=>'$conf->dolifullcalendar->enabled',
		//	// Use 'perms'=>'$user->rights->dolifullcalendar->level1->level2'
		...
		//	'type'=>'left',
		// Menu's title. FIXME: use a translation key
		//	'titre'=>'DoliFullCalendar left menu',
		// This menu's mainmenu ID
		//	'mainmenu'=>'dolifullcalendar',
		// This menu's leftmenu ID
		//	'leftmenu'=>'dolifullcalendar',
		//	'url'=>'/dolifullcalendar/pagelevel1.php',
		//	// Lang file to use (without .lang) by module.
		//	// File must be in langs/code_CODE/ directory.
		//	'langs'=>'mylangfile',
		//	'position'=>100,
		...
		// This menu's leftmenu ID
		//	'leftmenu'=>'dolifullcalendar',
		//	'url'=>'/dolifullcalendar/pagelevel2.php',
		//	// Lang file to use (without .lang) by module.
		//	// File must be in langs/code_CODE/ directory.
		//	'langs'=>'mylangfile',
		//	'position'=>100,
	 ...
	 * and create data commands must be stored in directory /dolifullcalendar/sql/
	...
	{
		return $this->_load_tables('/dolifullcalendar/sql/');
	}
}
