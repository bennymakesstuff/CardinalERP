...
$sql .= " " . "SUM(" . LLX_ . "projet_task_time.task_duration) AS total_task_duration";
		...
		$sql .= " FROM ";
		$sql .= "" . LLX_ . "projet_task as t    join " . LLX_ . "projet on t.fk_projet = " . LLX_ . "projet.rowid   left join " . LLX_ . "projet_task_time on t.rowid = " . LLX_ . "projet_task_time.fk_task   left join (      SELECT        " . LLX_ . "element_contact.element_id,         GROUP_CONCAT(concat(" . LLX_ . "element_contact.fk_socpeople, '-', upper(substring(" . LLX_ . "c_type_contact.source, 1, 1))), ',') as contactsIdsWithSource      FROM        " . LLX_ . "element_contact  LEFT JOIN " . LLX_ . "c_type_contact ON " . LLX_ . "element_contact.fk_c_type_contact = " . LLX_ . "c_type_contact.rowid      WHERE       " . LLX_ . "c_type_contact.element = 'project_task'      Group by        " . LLX_ . "element_contact.element_id     ) AS contacts on t.rowid = contacts.element_id";
