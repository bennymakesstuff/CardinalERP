...
$sql .= " " . "" . LLX_ . "projet.rowid AS projet_rowid,";
...
$sql .= " " . "" . LLX_ . "socpeople.photo AS photo";
		...
		$sql .= " FROM ";
		$sql .= "" . LLX_ . "element_contact AS t   LEFT JOIN " . LLX_ . "projet ON t.element_id = " . LLX_ . "projet.rowid   left join " . LLX_ . "c_type_contact on t.fk_c_type_contact = " . LLX_ . "c_type_contact.rowid   left join " . LLX_ . "socpeople on t.fk_socpeople = " . LLX_ . "socpeople.rowid";

		// --------- WHERE
		$WHERE = "  " . LLX_ . "c_type_contact.element = 'project'  and  " . LLX_ . "c_type_contact.source = 'external'";
		$WHERE = trim($WHERE);
		if (!empty($_WHERE)) {
			if ($_isNewWhere)
