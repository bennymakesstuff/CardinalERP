...
$sql .= " " . "COUNT(" . LLX_ . "commandedet.rowid) AS nbre_lignes,";
...
$sql .= " " . "COUNT(CASE WHEN " . LLX_ . "product.fk_product_type = 1 THEN 1 ELSE NULL END) AS nbre_services";
		...
		$sql .= " FROM ";
		$sql .= "" . LLX_ . "commande as t    left join " . LLX_ . "societe on t.fk_soc = " . LLX_ . "societe.rowid   left join " . LLX_ . "commandedet on t.rowid = " . LLX_ . "commandedet.fk_commande   left join " . LLX_ . "product on " . LLX_ . "commandedet.fk_product = " . LLX_ . "product.rowid";
		...
		// ----------- GROUP BY
		$GROUPBY = "t.rowid,    id,  t.ref,    t.entity,    t.ref_ext,    t.ref_int,    t.ref_client,    t.fk_soc,    t.fk_projet,    t.tms,    t.date_creation,    t.date_valid,    t.date_cloture,    t.date_commande,    t.fk_user_author,    t.fk_user_modif,    t.fk_user_valid,    t.fk_user_cloture,    t.source,    t.fk_statut,    t.amount_ht,    t.remise_percent,    t.remise_absolue,    t.remise,    t.tva,    t.localtax1,    t.localtax2,    t.total_ht,    t.total_ttc,    t.note_private,    t.note_public,    t.facture,    t.fk_currency,    t.fk_cond_reglement,    t.fk_mode_reglement,    t.date_livraison,    t.fk_warehouse,    t.fk_availability,    t.fk_input_reason,    t.extraparams,       societe_nom,    societe_name_alias,   societe_logo";
